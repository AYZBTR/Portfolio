...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      data-scroll-section
      className="px-10 md:px-20 py-32 flex flex-col md:flex-row items-center justify-between"
    >
      {/* LEFT SIDE TEXT */}
      <div className="max-w-xl">
        ...
        <p className="text-gray-300 mt-6 text-lg leading-relaxed">
          I specialize in the MERN stack — crafting fast, scalable, and beautifully
          designed applications with clean architecture.
        </p>
